...
function StockList() {
  ...
  return (
    <div className="bg-[#131722] w-1/4 h-screen flex flex-col text-[#d1d4dc] font-sans border-l border-[#2a2e39]">
      {/* 1. Header (Fixed) */}
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        {stocks.map((stock, index) => (
          <div
            key={index}
            className="flex justify-between items-center px-4 py-2.5 hover:bg-[#2a2e39] cursor-pointer border-b border-[#1e222d]"
          >
