        ...
        <Draggable nodeRef={nodeRef} handle=".draggable-header">
            ...
            >
                ...
                <div className="bg-slate-950 p-4 border-t border-slate-800 flex justify-between items-center">
                    ...
                    <button className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-8 rounded shadow-lg transition-all transform active:scale-95 uppercase tracking-wide text-sm">
                        Place Buy Order
                    </button>
                </div>
